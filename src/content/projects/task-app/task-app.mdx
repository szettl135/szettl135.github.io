...
import main_screen from './main_screen.png';
import main_screen_check from './main_screen_check.png';
import main_screen_delete from './main_screen_delete.png';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={main_screen} alt="Task App Main Screen" />
    <Image src={main_screen_check} alt="Task App Main Screen after checking task" />
    <Image src={main_screen_delete} alt="Task App Main Screen after deleting task" />
  </div>
</figure>
...
import add_task_select_date from './add_task_select_date.png';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={add_task} alt="Task App add task screen" />
    <Image src={add_task_select_date} alt="Task App add task screen showing date selection" />
  </div>
</figure>
...
import task_detail_screen from './task_detail_screen.png';
import task_edit_screen from './task_edit_screen.png';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={task_detail_screen} alt="Task App task detail screen" />
    <Image src={task_edit_screen} alt="Task App task edit screen" />
  </div>
</figure>
