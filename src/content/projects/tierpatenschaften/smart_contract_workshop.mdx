...
![View of our smart contract files](./tierpatenschaften_06.png)
...
![Main screen of the zoo](./tierpatenschaften_01.png)
...
![Page for kangaroos](./tierpatenschaften_02.png)
...
![Animal description and sponsorships](./tierpatenschaften_03.png)
...
import tierpatenschaften_04 from './tierpatenschaften_04.png';
import tierpatenschaften_05 from './tierpatenschaften_05.png';

<figure>
  <div class="img-row">
    <Image src={tierpatenschaften_04} alt="Kangaroo nft inside wallet" />
    <Image src={tierpatenschaften_05} alt="Kangaroo nft detail view" />
  </div>
</figure>
