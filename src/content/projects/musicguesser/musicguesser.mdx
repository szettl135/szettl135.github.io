...
import guesser_mainscreen from './guesser_mainscreen.jpg';
import guesser_addscreen from './guesser_addscreen.jpg';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={guesser_mainscreen} alt="MusicGuesser Main Screen" />
    <Image src={guesser_addscreen} alt="MusicGuesser Add Screen" />
  </div>
</figure>
...
import guesser_songscreen from './guesser_songscreen.jpg';

<figure class="img-portrait">
    <Image src={guesser_songscreen} alt="MusicGuesser Song Screen" />
</figure>
...
import guesser_gamescreen from './guesser_gamescreen.jpg';
import guesser_resultscreen from './guesser_resultscreen.jpg';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={guesser_gamescreen} alt="MusicGuesser Game Screen" />
    <Image src={guesser_resultscreen} alt="MusicGuesser Result Screen" />
  </div>
</figure>
