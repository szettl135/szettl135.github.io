...
import login_screen from './login_screen.jpg';
import chat_screen from './chat_screen.jpg';
import chat_example from './chat_example.jpg';

<figure class="img-portrait">
  <div class="img-row">
    <Image src={login_screen} alt="Login Screen" />
    <Image src={chat_screen} alt="Chat Screen" />
    <Image src={chat_example} alt="Example Chat" />
  </div>
</figure>
